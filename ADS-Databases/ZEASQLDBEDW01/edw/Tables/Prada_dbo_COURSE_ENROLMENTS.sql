CREATE TABLE [edw].[Prada_dbo_COURSE_ENROLMENTS] (
...
CREATE NONCLUSTERED INDEX [idx_edw_Prada_dbo_COURSE_ENROLMENTS_ENROLMENT_YEAR]
    ON [edw].[Prada_dbo_COURSE_ENROLMENTS]([ENROLMENT_YEAR] ASC);
GO

CREATE NONCLUSTERED INDEX [idx_edw_Prada_dbo_COURSE_ENROLMENTS_REPORT_DATE]
    ON [edw].[Prada_dbo_COURSE_ENROLMENTS]([REPORT_DATE] ASC);
GO
