...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARDS_ORIGINAL] ALTER COLUMN [CREATED_DATE] DATETIME2 (7) NULL;

ALTER TABLE [edw].[OneEBS_EBS_0165_AWARDS_ORIGINAL] ALTER COLUMN [UPDATED_DATE] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNITS]
    ADD [HIGHEST_ATTAINMENT_CODE] VARCHAR (40) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UNIT_INSTANCE_OCCURRENCES]
    ADD [ATTENDANCE_TYPE] VARCHAR (40) NULL;
...
GO
PRINT N'Refreshing View [OneEBS].[Attached_Waiver_Values]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Attached_Waiver_Values]';


GO
PRINT N'Refreshing View [OneEBS].[Attainment_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Attainment_Links]';
...
GO
PRINT N'Refreshing View [OneEBS].[Award_Attainment_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Award_Attainment_Links]';


GO
PRINT N'Refreshing View [OneEBS].[Award_Rulesets]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Award_Rulesets]';


GO
PRINT N'Refreshing View [OneEBS].[Awards_Printed_Details]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Awards_Printed_Details]';


GO
PRINT N'Refreshing View [OneEBS].[Communications]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Communications]';


GO
PRINT N'Refreshing View [OneEBS].[Configurable_Statuses]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Configurable_Statuses]';
...
GO
PRINT N'Refreshing View [OneEBS].[Course_Assessments_Results]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Course_Assessments_Results]';


GO
PRINT N'Refreshing View [OneEBS].[Disabilities]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Disabilities]';
...
GO
PRINT N'Refreshing View [OneEBS].[Fee_Type_Waivers]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Fee_Type_Waivers]';
...
GO
PRINT N'Refreshing View [OneEBS].[Grading_Scheme_Grades]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Grading_Scheme_Grades]';


GO
PRINT N'Refreshing View [OneEBS].[Grading_Schemes]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Grading_Schemes]';
...
GO
PRINT N'Refreshing View [OneEBS].[Marking_Rule_Assessments]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Marking_Rule_Assessments]';


GO
PRINT N'Refreshing View [OneEBS].[Marking_Rule_Properties]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Marking_Rule_Properties]';


GO
PRINT N'Refreshing View [OneEBS].[Marking_Rules]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Marking_Rules]';


GO
PRINT N'Refreshing View [OneEBS].[Modes_Of_Provision]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Modes_Of_Provision]';


GO
PRINT N'Refreshing View [OneEBS].[Notes]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Notes]';


GO
PRINT N'Refreshing View [OneEBS].[Notes_Topics]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Notes_Topics]';


GO
PRINT N'Refreshing View [OneEBS].[Org_Unit_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Org_Unit_Links]';


GO
PRINT N'Refreshing View [OneEBS].[Org_Unit_People]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Org_Unit_People]';
...
GO
PRINT N'Refreshing View [OneEBS].[People_Centrelink]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Centrelink]';


GO
PRINT N'Refreshing View [OneEBS].[People_UIO]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_UIO]';


GO
PRINT N'Refreshing View [OneEBS].[People_Unit_Attainments]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Unit_Attainments]';


GO
PRINT N'Refreshing View [OneEBS].[People_Unit_Awards]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Unit_Awards]';


GO
PRINT N'Refreshing View [OneEBS].[People_Unit_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Unit_Links]';
...
GO
PRINT N'Refreshing View [OneEBS].[People_Units_Centrelink]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Units_Centrelink]';
...
GO
PRINT N'Refreshing View [OneEBS].[People_Units_Sts]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[People_Units_Sts]';
...
GO
PRINT N'Refreshing View [OneEBS].[Price_Bands]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Price_Bands]';


GO
PRINT N'Refreshing View [OneEBS].[Progress_Codes]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Progress_Codes]';
...
GO
PRINT N'Refreshing View [OneEBS].[Progress_Types]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Progress_Types]';


GO
PRINT N'Refreshing View [OneEBS].[Rc_Reports]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Rc_Reports]';


GO
PRINT N'Refreshing View [OneEBS].[Register_Event_Details]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Register_Event_Details]';
...
GO
PRINT N'Refreshing View [OneEBS].[Register_Events]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Register_Events]';


GO
PRINT N'Refreshing View [OneEBS].[Rooms]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Rooms]';


GO
PRINT N'Refreshing View [OneEBS].[Rules]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Rules]';


GO
PRINT N'Refreshing View [OneEBS].[Ruleset_Rules]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Ruleset_Rules]';


GO
PRINT N'Refreshing View [OneEBS].[Rulesets]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Rulesets]';
...
GO
PRINT N'Refreshing View [OneEBS].[Skills_List_Items]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Skills_List_Items]';


GO
PRINT N'Refreshing View [OneEBS].[Skills_Lists]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Skills_Lists]';


GO
PRINT N'Refreshing View [OneEBS].[Student_Status_Log]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Student_Status_Log]';


GO
PRINT N'Refreshing View [OneEBS].[Tills]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Tills]';


GO
PRINT N'Refreshing View [OneEBS].[UI_Target_Audiences]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UI_Target_Audiences]';


GO
PRINT N'Refreshing View [OneEBS].[UIO_Instalment_Plans]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UIO_Instalment_Plans]';


GO
PRINT N'Refreshing View [OneEBS].[UIO_Instalments]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UIO_Instalments]';


GO
PRINT N'Refreshing View [OneEBS].[UIO_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UIO_Links]';


GO
PRINT N'Refreshing View [OneEBS].[UIO_Organisation_Units]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UIO_Organisation_Units]';


GO
PRINT N'Refreshing View [OneEBS].[Unit_Instance_Awards]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Unit_Instance_Awards]';
...
GO
PRINT N'Refreshing View [OneEBS].[Usages]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Usages]';
...
GO
PRINT N'Refreshing View [OneEBS].[Vat_Rates]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Vat_Rates]';
...
GO
PRINT N'Refreshing View [OneEBS].[Waiver_Types]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Waiver_Types]';
...
GO
PRINT N'Refreshing View [OneEBS].[Waiver_Values]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Waiver_Values]';
...
GO
PRINT N'Refreshing View [OneEBS].[900_UI_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[900_UI_Links]';


GO
PRINT N'Refreshing View [OneEBS].[UI_Links]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UI_Links]';
...
GO
PRINT N'Refreshing View [OneEBS].[900_Verifier_Properties]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[900_Verifier_Properties]';


GO
PRINT N'Refreshing View [OneEBS].[Verifier_Properties]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Verifier_Properties]';


GO
PRINT N'Refreshing View [OneEBS].[900_Verifiers]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[900_Verifiers]';


GO
PRINT N'Refreshing View [OneEBS].[Verifiers]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Verifiers]';
