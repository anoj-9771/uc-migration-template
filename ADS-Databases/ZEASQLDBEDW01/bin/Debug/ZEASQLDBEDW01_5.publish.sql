...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ADDRESSES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ATTACHED_WAIVER_VALUES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ATTAINMENT_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
PRINT N'Altering Table [edw].[OneEBS_EBS_0165_AUTHORITY_TO_DELIVER]...';


GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AUTHORITY_TO_DELIVER] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARD_ATTAINMENT_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARD_RULESETS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARDS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARDS_ORIGINAL] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_AWARDS_PRINTED_DETAILS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_CALENDAR_OCCURRENCES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_COMMUNICATIONS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_CONFIGURABLE_STATUSES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_COURSE_ASSESSMENTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_COURSE_ASSESSMENTS_RESULTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_DISABILITIES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEE_CATEGORIES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEE_TYPE_WAIVERS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEE_TYPES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEE_VALUES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEES_LIST_ALLOCATED] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEES_LIST_SPECIAL] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEES_LIST_TEMP] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_FEES_LIST_WAIVERS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_GRADING_SCHEME_GRADES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_GRADING_SCHEMES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_INSTALMENT_PLANS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_LOCATIONS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_MARKING_RULE_ASSESSMENTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_MARKING_RULE_PROPERTIES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_MARKING_RULES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_MODES_OF_PROVISION] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_NOTES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_NOTES_TOPICS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ORG_UNIT_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ORG_UNIT_PEOPLE] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_ASR] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_CENTRELINK] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UIO] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNIT_ATTAINMENTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNIT_AWARDS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNIT_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNITS_AVETMISS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNITS_CENTRELINK] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNITS_FINANCIAL] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_UNITS_STS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PEOPLE_USI] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PRICE_BANDS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PROGRESS_CODES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_PROGRESS_TYPES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_RC_REPORTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_REGISTER_EVENT_DETAILS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_REGISTER_EVENTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_ROOMS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_RULES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_RULESET_RULES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_RULESETS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_SCHOOLS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_SKILLS_LIST_ITEMS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_SKILLS_LISTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_STUDENT_STATUS_LOG] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_TILLS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
PRINT N'Altering Table [edw].[OneEBS_EBS_0165_UI_ACCREDITATION]...';


GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UI_ACCREDITATION] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UI_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UI_TARGET_AUDIENCES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UIO_INSTALMENT_PLANS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UIO_INSTALMENTS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UIO_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UIO_ORGANISATION_UNITS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UNIT_INSTANCE_AWARDS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_UNIT_INSTANCES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_USAGES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_VAT_RATES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_VERIFIER_PROPERTIES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_VERIFIERS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_VISA_SUBCLASSES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_VISAS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_WAIVER_TYPES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_WAIVER_VALUES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_WEB_CONFIG] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0165_Z_READ_BATCHES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0900_UI_LINKS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0900_UNIT_INSTANCES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0900_VERIFIER_PROPERTIES] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
ALTER TABLE [edw].[OneEBS_EBS_0900_VERIFIERS] ALTER COLUMN [_transaction_date] DATETIME2 (7) NULL;
...
GO
PRINT N'Refreshing View [OneEBS].[Authority_To_Deliver]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[Authority_To_Deliver]';
...
GO
PRINT N'Refreshing View [OneEBS].[UI_ACCREDITATION]...';


GO
EXECUTE sp_refreshsqlmodule N'[OneEBS].[UI_ACCREDITATION]';
