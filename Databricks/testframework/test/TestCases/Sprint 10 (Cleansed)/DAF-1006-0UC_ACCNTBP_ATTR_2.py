...
# MAGIC %sql
# MAGIC select ZAHLKOND as paymentConditionCode
# MAGIC ,KOFIZ_SD as accountDeterminationCode
# MAGIC from test.${vars.table}
...
# MAGIC ,accountDeterminationId
# MAGIC from
# MAGIC cleansed.${vars.table}
# MAGIC except
# MAGIC select ZAHLKOND as paymentCondition
# MAGIC ,KOFIZ_SD as accountDeterminationId
# MAGIC from test.${vars.table}
