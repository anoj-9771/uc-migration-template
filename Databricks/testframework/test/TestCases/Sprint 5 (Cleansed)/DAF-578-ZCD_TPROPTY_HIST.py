...
file_location = "wasbs://archive@saswcnonprod01landingtst.blob.core.windows.net/sapisu/20210901/20210901_13:17:34/ZCD_TPROPTY_HIST_20210831124243.json"
file_type = "json"
...
# MAGIC %sql
# MAGIC SELECT propertyNumber,superiorPropertyTypeCode,inferiorPropertyTypeCode, COUNT (*) as count
# MAGIC FROM cleansed.t_sapisu_zcd_tpropty_hist
# MAGIC GROUP BY propertyNumber,superiorPropertyTypeCode,inferiorPropertyTypeCode
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY propertyNumber,superiorPropertyTypeCode,inferiorPropertyTypeCode order by validFromDate) as rn
# MAGIC FROM  cleansed.t_sapisu_zcd_tpropty_hist
