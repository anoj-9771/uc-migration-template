...
# MAGIC ,N_NETTOBTR_L as longNetAmountDecimalPlaces
# MAGIC from test.isu_dberchz3
# MAGIC where BELNR = '010000003963'and BELZEILE ='000002'
# MAGIC except
# MAGIC select
...
# MAGIC from cleansed.isu_dberchz3 where billingDocumentNumber ='010000003963'and billingDocumentLineItemId='000002'
...
# MAGIC ,N_NETTOBTR_L as longNetAmountDecimalPlaces
# MAGIC from test.isu_dberchz3 --where DELTA_TS<'20211117055649'
# MAGIC where BELNR = '010000011426' and BELZEILE ='000011'

# COMMAND ----------

# DBTITLE 1,Single Target query
# MAGIC %sql
# MAGIC select
# MAGIC billingDocumentNumber
# MAGIC ,billingDocumentLineItemId
...
# MAGIC ,longNetAmountDecimalPlaces
# MAGIC FROM
# MAGIC cleansed.isu_dberchz3 where billingDocumentNumber = '010000011426' and billingDocumentLineItemId ='000011'
