...
# MAGIC %sql
# MAGIC SELECT disconnecionReasonCode,disconnecionReason, COUNT (*) as count
# MAGIC FROM cleansed.${vars.table}
# MAGIC GROUP BY disconnecionReasonCode,disconnecionReason
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY disconnecionReasonCode order by disconnecionReasonCode) as rn
# MAGIC FROM  cleansed.${vars.table}
# MAGIC )a where a.rn > 1
