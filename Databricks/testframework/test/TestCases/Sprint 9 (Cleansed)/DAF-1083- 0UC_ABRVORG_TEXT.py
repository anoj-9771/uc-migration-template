...
# MAGIC %sql
# MAGIC drop table if exists test.isu_0uc_abrvorg_text
...
# MAGIC %sql
# MAGIC select distinct EXTRACT_DATETIME from test.isu_0uc_abrvorg_text order by EXTRACT_DATETIME desc
...
# MAGIC from test.isu_0uc_abrvorg_text) where rn=1

# COMMAND ----------

# DBTITLE 1,[Verification] Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.isu_0uc_abrvorg_text
# MAGIC union all
...
# MAGIC %sql
# MAGIC SELECT billingTransactionCode,billingTransaction,
# MAGIC COUNT (*) as count
# MAGIC FROM cleansed.isu_0uc_abrvorg_text
# MAGIC GROUP BY billingTransactionCode,billingTransaction
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY billingTransactionCode order by billingTransactionCode) as rn
# MAGIC FROM  cleansed.isu_0uc_abrvorg_text
...
# MAGIC billingTransaction
# MAGIC from
# MAGIC cleansed.isu_0uc_abrvorg_text
