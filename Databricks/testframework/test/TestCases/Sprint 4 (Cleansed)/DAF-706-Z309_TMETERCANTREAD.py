...
# DBTITLE 1,[Source] loading to a dataframe
 df = spark.read.format("csv").option('delimiter','|').option('header','true').load("wasbs://raw@sadaftest01.blob.core.windows.net/landing/accessarchive/Z309_TMETERCANTREAD.csv")
...
# MAGIC %sql
# MAGIC select * from cleansed.t_access_z309_tmetercantread
