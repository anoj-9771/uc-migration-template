...
# MAGIC addressLine8,
# MAGIC mobileNumber,
# MAGIC phoneNumberWithExtension,
# MAGIC postalCodeExtension,
# MAGIC poBoxExtension,
# MAGIC deliveryServiceTypeCode,
# MAGIC deliveryServiceNumber
# MAGIC from
# MAGIC (Select PARTNER as businessPartnerNumber,
...
# MAGIC ZZMOBILENO as mobileNumber,
# MAGIC ZZTELNO as phoneNumberWithExtension,
# MAGIC PCODE1_EXT as postalCodeExtension,
# MAGIC PCODE2_EXT as poBoxExtension,
# MAGIC DELI_SERV_TYPE as deliveryServiceTypeCode,
# MAGIC DELI_SERV_NUMBER as deliveryServiceNumber
...
# MAGIC %sql
# MAGIC SELECT businessPartnerNumber,businessPartnerGUID,addressNumber,validFromDate,validToDate,titleCode,businessPartnerName1,
# MAGIC businessPartnerName2,businessPartnerName3,coName,cityName,cityCode,postalCode,poBoxPostalCode,companyPostalCode,poBoxCode,
# MAGIC poBoxWithoutNumberIndicator,poBoxCity,cityPoBoxCode,streetName,streetCode,houseNumber,houseNumber2,streetType,streetLine3,
# MAGIC streetLine4,streetLine5,building,floorNumber,appartmentNumber,countryShortName,stateCode,personalAddressIndicator,searchTerm1,
# MAGIC searchTerm2,phoneNumber,faxNumber,addressTimeZone,emailAddress,uriAddress,phoneNumberDisplayFormat,faxDisplayFormat,longitude,
# MAGIC latitude,altitude,precision,communicationAddressNumber,shortFormattedAddress,shortFormattedAddress2,addressLine0,addressLine1,
# MAGIC addressLine2,addressLine3,addressLine4,addressLine5,addressLine6,addressLine7,addressLine8,mobileNumber,phoneNumberWithExtension,
# MAGIC postalCodeExtension,poBoxExtension,deliveryServiceTypeCode,deliveryServiceNumber, COUNT (*) as count
# MAGIC FROM cleansed.${vars.table}
# MAGIC GROUP BY businessPartnerNumber,businessPartnerGUID,addressNumber,validFromDate,validToDate,titleCode,businessPartnerName1,
# MAGIC businessPartnerName2,businessPartnerName3,coName,cityName,cityCode,postalCode,poBoxPostalCode,companyPostalCode,poBoxCode,
# MAGIC poBoxWithoutNumberIndicator,poBoxCity,cityPoBoxCode,streetName,streetCode,houseNumber,houseNumber2,streetType,streetLine3,
# MAGIC streetLine4,streetLine5,building,floorNumber,appartmentNumber,countryShortName,stateCode,personalAddressIndicator,searchTerm1,
# MAGIC searchTerm2,phoneNumber,faxNumber,addressTimeZone,emailAddress,uriAddress,phoneNumberDisplayFormat,faxDisplayFormat,longitude,
# MAGIC latitude,altitude,precision,communicationAddressNumber,shortFormattedAddress,shortFormattedAddress2,addressLine0,addressLine1,
# MAGIC addressLine2,addressLine3,addressLine4,addressLine5,addressLine6,addressLine7,addressLine8,mobileNumber,phoneNumberWithExtension,
# MAGIC postalCodeExtension,poBoxExtension,deliveryServiceTypeCode,deliveryServiceNumber
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY businessPartnerNumber,addressNumber order by businessPartnerNumber,addressNumber) as rn
# MAGIC FROM  cleansed.${vars.table}
# MAGIC )a where a.rn > 1
