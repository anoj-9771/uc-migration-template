...
# MAGIC %sql
# MAGIC SELECT 
# MAGIC promiseToPayId,paymentDatePromised,paymentAmountPromised,
# MAGIC promisedAmountOpen,currency,amount2,amount1,createdDate
# MAGIC , COUNT (*) as count
# MAGIC FROM cleansed.${vars.table}
# MAGIC GROUP BY promiseToPayId,paymentDatePromised,paymentAmountPromised,
# MAGIC promisedAmountOpen,currency,amount2,amount1,createdDate
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY promiseToPayId,paymentDatePromised  order by promiseToPayId,paymentDatePromised) as rn
# MAGIC FROM  cleansed.${vars.table}
