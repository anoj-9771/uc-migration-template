...
lakedf = spark.sql("select * from raw.sapisu_0uc_reggrp_text")
...
# MAGIC %sql
# MAGIC select * from raw.sapisu_0uc_reggrp_text

# COMMAND ----------

# DBTITLE 1,[Verification] Record Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from raw.sapisu_0uc_reggrp_text
# MAGIC union all
...
# MAGIC ,ODQ_ENTITYCNTR                       
# MAGIC ,ZWGRUPPE                                                                                    
# MAGIC from raw.sapisu_0uc_reggrp_text
