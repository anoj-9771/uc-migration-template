...
# MAGIC %sql
# MAGIC select * from raw.sapisu_0df_refixfi_text

# COMMAND ----------

# DBTITLE 0,[Result] Load Count Result into DataFrame
lakedf = spark.sql("select * from raw.sapisu_0df_refixfi_text")
...
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from raw.sapisu_0df_refixfi_text
# MAGIC union all
...
# MAGIC   SPRAS,
# MAGIC   XFIXFITCHARACT 
# MAGIC  from raw.sapisu_0df_refixfi_text
