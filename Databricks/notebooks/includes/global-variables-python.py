...
ADS_BLOB_STORAGE_ACCOUNT = ADS_BLOB_STORAGE_ACCOUNT = "sablobdaf"+ ADS_ENVIRONMENT + "01" #ADS_COMPANY_INITIAL + "stor" + ADS_BUSINESS_UNIT + ADS_ENVIRONMENT + ".blob.core.windows.net"
