...
GRANT USAGE, SELECT, READ_METADATA ON SCHEMA semantic TO `A-Azure-rg-$env-daf-01-DataAnalystStdUsr`;
...
GRANT USAGE, SELECT, READ_METADATA ON SCHEMA semantic TO `A-Azure-rg-$env-daf-01-DataAnalystAdvUsr`;
