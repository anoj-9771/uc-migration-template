...
def getmeterTimesliceAccess():
    ...
    #1.Load current Cleansed layer table data into dataframe
        ...
        #t2: join history and current together. Only take the latest row for a date for history
    ...
    df = spark.sql(" \
            with history as( \
                      SELECT 'HISTORY' as src, hpm.propertyNumber, hpm.propertyMeterNumber, hpm.meterSizeCode, hpm.meterSize, hpm.meterReadingFrequencyCode, coalesce(pm.meterFittedDate,hpm.meterFittedDate) as meterFittedDate, \
                              ...
                              hpm.meterMakerNumber, hpm.meterClassCode, hpm.meterClass, hpm.meterCategoryCode, hpm.meterCategory, hpm.meterGroupCode, hpm.meterGroup, \
                 ...
                 t2 as( \
                      select distinct dataSource as src, pm.propertyNumber, pm.propertyMeterNumber, meterSizeCode, meterSize, pm.meterReadingFrequencyCode, pm.meterFittedDate, \
                             ...
                             pm.meterMakerNumber, meterClassCode, meterClass, meterCategoryCode, meterCategory, meterGroupCode, meterGroup, isMasterMeter, isCheckMeter, allowAlso, waterMeterType, propertyMeterUpdatedDate, \
                      ...
                      select src, t1.propertyNumber, t1.propertyMeterNumber, t1.meterSizeCode, t1.meterSize, t1.meterReadingFrequencyCode, t1.meterFittedDate, \
                             coalesce(t1.meterRemovedDate,t1a.newMeterRemovedDate) as meterRemovedDate, t1.meterMakerNumber, \
                 ...
                 t3 as( \
                      select distinct src, propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, \
                 ...
                 t4 as( \
                      select t3.propertyNumber, t3.propertyMeterNumber, t3.meterSizeCode, t3.meterSize, t3.meterReadingFrequencyCode, t3.meterFittedDate, \
                             meterRemovedDate, t3.meterMakerNumber, \
                      ...
                      select propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, \
                             meterRemovedDate, meterMakerNumber, \
                 ...
                 t5 as( \
                      select distinct propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
                 ...
                 t6 as( \
                      select propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
                 ...
                 t7 as( \
                      SELECT \
                          propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
                      ...
                      GROUP BY propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
                             meterCategoryCode, meterCategory, meterGroupCode, meterGroup, isMasterMeter, isCheckMeter, allowAlso, waterMeterType, grp \
                      ORDER BY propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
                             meterCategoryCode, meterCategory, meterGroupCode, meterGroup, isMasterMeter, isCheckMeter, allowAlso, waterMeterType, validFrom \
                      ) \
            select propertyNumber, propertyMeterNumber, meterSizeCode, meterSize, meterReadingFrequencyCode, meterFittedDate, meterRemovedDate, meterMakerNumber, meterClassCode, meterClass, \
...
# MAGIC %sql
# MAGIC select *
# MAGIC from curated.meterTimesliceACCESS
