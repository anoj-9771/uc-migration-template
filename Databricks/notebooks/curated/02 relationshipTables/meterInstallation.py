...
TemplateEtl(df, entity="meterInstallation", businessKey="installationSK,installationId,logicalDeviceNumber,validToDate", schema=schema, writeMode=ADS_WRITE_MODE_MERGE, AddSK=False)
