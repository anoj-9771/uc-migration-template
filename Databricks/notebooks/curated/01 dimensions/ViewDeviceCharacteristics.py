...
CREATE OR REPLACE VIEW curated.viewDeviceCharacteristics AS
...
FROM  curated.dimDeviceCharacteristics where deviceNumber in (select distinct deviceNumber from curated.viewDevice) 
)
