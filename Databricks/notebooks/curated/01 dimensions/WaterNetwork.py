...
def getWaterNetwork():
    ...
    dummyDimRecDf = spark.createDataFrame([("Unknown","Unknown","-1","-1","Unknown","Unknown")], ["deliverySystem", "distributionSystem","supplyZone","pressureArea","isPotableWaterNetwork","isRecycledWaterNetwork"])
