...
def getWaterNetwork():
    ...
    dummyDimRecDf = spark.createDataFrame([("Unknown","Unknown","Unknown","-1","Unknown","Unknown"),("NA","NA","-2","NA","NA","NA")], ["deliverySystem", "distributionSystem","supplyZone","pressureArea","isPotableWaterNetwork","isRecycledWaterNetwork"])
