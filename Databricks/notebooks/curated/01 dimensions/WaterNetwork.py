...
def getWaterNetwork():
    ...
    dummyDimRecDf = spark.createDataFrame([("Unknown","Unknown","-1","-1","Y","N"), ("Unknown","Unknown","-1","-1","N","Y")], ["deliverySystem", "distributionSystem","supplyZone","pressureArea","isPotableWaterNetwork","isRecycledWaterNetwork"])
