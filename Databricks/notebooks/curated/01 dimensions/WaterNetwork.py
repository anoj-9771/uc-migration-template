...
def getWaterNetwork():
    ...
    dummyDimRecDf = spark.createDataFrame([("Unknown","Unknown","-1","Unknown","Y","N"), ("Unknown","Unknown","Unknown","-1","N","Y")], ["deliverySystem", "distributionSystem","supplyZone","pressureArea","isPotableWaterNetwork","isRecycledWaterNetwork"])
