...
def getWaterNetwork():
    ...
    dummyDimRecDf = spark.createDataFrame([("Unknown","Unknown","Unknown","Unknown","N","N")], ["deliverySystem", "distributionSystem","supplyZone","pressureArea","isRecycledWaterNetwork","isPotableWaterNetwork"])
