...
# MAGIC %sql
# MAGIC --create or replace TABLE curated.factdailyapportionedconsumption_isu as select * from curated.factdailyapportionedconsumption where sourcesystemcode = 'ISU'
# MAGIC --create or replace TABLE curated.factdailyapportionedconsumption_access as select * from curated.factdailyapportionedconsumption where sourcesystemcode = 'ACCESS'
# MAGIC --select count(1) from curated.factdailyapportionedconsumption_isu
# MAGIC --select count(1) from curated.factdailyapportionedconsumption_access
# MAGIC --select sourcesystemcode, _dlcuratedzonetimestamp, count(1) from curated.factdailyapportionedconsumption group by sourcesystemcode, _dlcuratedzonetimestamp order by 2 desc
# MAGIC --drop table curated.factdailyapportionedconsumption
# MAGIC -- CREATE TABLE `curated`.`factdailyapportionedconsumption` (
# MAGIC --   `sourceSystemCode` STRING NOT NULL,
# MAGIC --   `consumptionDate` DATE NOT NULL,
...
# MAGIC --   `dailyApportionedConsumption` DECIMAL(28,6),
...
# MAGIC -- LOCATION 'dbfs:/mnt/datalake-curated/factdailyapportionedconsumption/delta'
# MAGIC --insert into curated.factdailyapportionedconsumption (select * from curated.factdailyapportionedconsumption_isu)
# MAGIC --insert into curated.factdailyapportionedconsumption (select * from curated.factdailyapportionedconsumption_access)
# MAGIC --alter table curated.factdailyapportionedconsumption alter column waternetworksk drop not NULL
# MAGIC -- select sourcesystemcode, _dlcuratedzonetimestamp, count(1) from curated.factdailyapportionedconsumption group by sourcesystemcode, _dlcuratedzonetimestamp order by 2 desc

# COMMAND ----------

# MAGIC %sql
# MAGIC select sourcesystemcode, _dlcuratedzonetimestamp, count(1) from curated.factdailyapportionedconsumption
# MAGIC group by sourcesystemcode, _dlcuratedzonetimestamp
