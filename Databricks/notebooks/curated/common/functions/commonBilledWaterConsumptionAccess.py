...
def getBilledWaterConsumptionAccess():
    ...
    billedConsDf = spark.sql(f"""
                             select 
                              ...
                              from {ADS_DATABASE_CLEANSED}.access.z309_tmeterreading mr 
                                left join {ADS_DATABASE_CLEANSED}.access.meterTimeslice mts 
                                ...
                                left outer join {ADS_DATABASE_CLEANSED}.access.z309_tdebit dr 
...
# MAGIC   from {ADS_DATABASE_CLEANSED}.access.z309_tmeterreading mr --156365233
# MAGIC     left join {ADS_DATABASE_CLEANSED}.access.meterTimeslice mts --156,379,127
...
# MAGIC     left join curated.dimDevice dm  --?? -- 165,541,437
# MAGIC       on dm.deviceId = coalesce(mts.meterMakerNumber,'-1') and dm.sourceSystemCode = 'ACCESS'
# MAGIC     left outer join {ADS_DATABASE_CLEANSED}.access.z309_tdebit dr --165,615,246
