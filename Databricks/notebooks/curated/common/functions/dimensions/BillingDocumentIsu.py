...
def getBillingDocumentIsu():
  ...
  dummyDimRecDf = spark.createDataFrame([("ISU", "-1", "1900-01-01", "2099-12-31"), ("ACCESS", "-2", "1900-01-01", "2099-12-31"),("ISU", "-3", "1900-01-01", "2099-12-31"),("ACCESS", "-4", "1900-01-01", "2099-12-31")], ["sourceSystemCode", "billingDocumentNumber", "billingPeriodStartDate", "billingPeriodEndDate"])
