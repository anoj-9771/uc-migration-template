...
df_cleansed = spark.sql("SELECT C_METE_READ_CONS AS consumptionTypeCode, \
		...
		_RecordDeleted, \
		_RecordCurrent \
	FROM CLEANSED.STG_ACCESS_Z309_TMETEREADCONTYP \
         ")
...
newSchema = StructType([
	StructField('consumptionTypeCode',StringType(),False),
	StructField('consumptionType',StringType(),False),
	StructField('consumptionTypeEffectiveDate',DateType(),True),
	StructField('consumptionTypeCancelledDate',DateType(),True),
