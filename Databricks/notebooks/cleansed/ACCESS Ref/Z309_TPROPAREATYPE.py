...
import json
accessTable = 'Z309_TPROPAREATYPE'
businessKeys = 'propertyAreaTypeCode'
...
df_cleansed = spark.sql(f"SELECT \
	...
	D_PROP_AREA_TYPE_EFFE as propertyAreaTypeEffectiveDate, \
	D_PROP_AREA_TYPE_CANC as propertyAreaTypeCancelledDate, \
	_RecordStart, \
	_RecordEnd, \
	_RecordDeleted, \
	_RecordCurrent \
...
newSchema = StructType([
	StructField('propertyAreaTypeCode',StringType(),False),
	StructField('propertyAreaType',StringType(),True),
	StructField('propertyAreaTypeAbbreviation',StringType(),True),
	StructField('propertyAreaTypeEffectiveDate',StringType(),True),
	StructField('propertyAreaTypeCancelledDate',StringType(),True),
