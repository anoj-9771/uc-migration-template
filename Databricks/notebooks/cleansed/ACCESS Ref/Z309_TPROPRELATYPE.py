...
newSchema = StructType([
    ...
    StructField('relationshipTypeAbbreviation',StringType(),True),
    StructField('relationshipTypeEffectiveDate',DateType(),True),
    StructField('relationshipTypeCancelledDate',DateType(),True),
