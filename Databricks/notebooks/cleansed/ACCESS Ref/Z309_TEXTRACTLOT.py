...
import json
accessTable = 'Z309_TEXTRACTLOT'
businessKeys = 'extractLotCode'
...
newSchema = StructType([
	StructField('extractLotCode',StringType(),False),
	StructField('extractLotDescription',StringType(),True),
	StructField('extraLotInfoEffectiveDate',DateType(),True),
	StructField('extraLotInfoCancelledDate',DateType(),True),
