...
newSchema = StructType([
	StructField('sewerUsageTypeCode',StringType(),False),
	StructField('sewerUsageType',StringType(),True),
	StructField('sewerUsageTypeEffectiveDate',DateType(),True),
	StructField('sewerUsageTypeCancelledDate',DateType(),True),
