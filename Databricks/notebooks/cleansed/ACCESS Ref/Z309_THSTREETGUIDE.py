...
import json
accessTable = 'Z309_THSTREETGUIDE'
businessKeys = 'C_STRE_GUID,D_SUPD,T_TIME_SUPD'
...
df_cleansed = spark.sql(f"SELECT \
	...
	C_LGA as LGACode, \
	C_VALI_ADDI_STRE as streetSuffixCode, \
	M_STRE as streetName, \
	C_VALI_STRE_TYPE as streetTypeCode, \
	C_POST as postCode, \
	M_SUBU as suburb, \
...
newSchema = StructType([
	...
	StructField('streetSuffixCode',StringType(),True),
	StructField('streetName',StringType(),True),
	StructField('streetTypeCode',StringType(),True),
...
# MAGIC %sql
# MAGIC select * from {ADS_DATABASE_CLEANSED}.access.z309_thstreetguide
