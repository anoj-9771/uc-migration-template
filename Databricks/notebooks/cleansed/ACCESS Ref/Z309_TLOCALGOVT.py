...
df_local_govt = spark.sql("SELECT C_LGA AS LGACode, \
                ...
                T_LGA_ABBR AS LGAAbbreviation, \
                to_date(D_LGA_REGI_EFFE, 'yyyyMMdd') as LGAEffectiveDate, \
                to_date(D_LGA_REGI_CANC, 'yyyyMMdd') as LGACancelledDate, \
                _RecordStart, \
                _RecordEnd, \
                _RecordDeleted, \
                _RecordCurrent \
...
newSchema = StructType([
	...
	StructField('LGAAbbreviation',StringType(),True),
	StructField('LGAEffectiveDate',DateType(),True),
	StructField('LGACancelledDate',DateType(),True),
...
df_updated_column = spark.createDataFrame(df_local_govt.rdd, schema=newSchema)
