...
# 	"BusinessKeyColumn": "installationId,operandCode,validFromDate,consecutiveDaysFromDate", 
...
df = spark.sql(f"""
        WITH stage AS (
                ...
                SELECT
                    ...
                    ltrim('0', trim(BELNR))                             as billingDocumentNumber, 
                    ltrim('0', trim(MBELNR))                            as mBillingDocumentNumber, 
