...
print('target_table: ',target_table)
print('ADS_DATALAKE_ZONE_CLEANSED: ', ADS_DATALAKE_ZONE_CLEANSED)
print('ADS_DATABASE_CLEANSED: ', ADS_DATABASE_CLEANSED)
print('data_lake_folder: ', data_lake_folder)
print('ADS_WRITE_MODE_MERGE: ', ADS_WRITE_MODE_MERGE)
print('track_changes: ', track_changes)
print('is_delta_extract: ', is_delta_extract)
