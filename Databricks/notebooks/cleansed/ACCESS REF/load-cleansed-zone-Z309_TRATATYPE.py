...
df_rata_type = spark.sql("SELECT C_RATA_TYPE AS rateabilityTypeCode, \
        ...
        _RecordDeleted, \
		_RecordCurrent \
	FROM CLEANSED.STG_access_Z309_TRATATYPE")
...
newSchema = StructType([
	...
	StructField('rateabilityTypeEffectiveDate',DateType(),False),
	StructField('rateabilityTypeCancelledDate',DateType(),True),
