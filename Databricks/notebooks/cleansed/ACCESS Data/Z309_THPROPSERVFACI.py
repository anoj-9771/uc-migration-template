...
import json
accessTable = 'Z309_THPROPSERVFACI'
...
df_cleansed = spark.sql(f"SELECT \
    ...
    if(d_prop_serv_conn = '00000000',ToValidDate(tbl.D_PROP_SERV_LIAB),ToValidDate(tbl.D_PROP_SERV_CONN)) as serviceConnectionDate, \
	cast(tbl.Q_PROP_SERV_WC as int) as numberOfWaterClosets, \
	cast(tbl.Q_PROP_SERV_UC as int) as numberOfUrinaryCisterns, \
	if(D_PROP_SERV_AVAI='00000000',ToValidDate(tbl.D_PROP_SERV_LIAB),ToValidDate(tbl.D_PROP_SERV_AVAI)) as serviceAvailableDate, \
...
# MAGIC %sql
# MAGIC select * 
# MAGIC from   {ADS_DATABASE_CLEANSED}.access.Z309_THPROPSERVFACI
