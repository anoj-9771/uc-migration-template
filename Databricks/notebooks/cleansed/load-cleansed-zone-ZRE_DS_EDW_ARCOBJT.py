...
#{"SourceType": "BLOB Storage (json)", "SourceServer": "daf-sa-lake-sastoken", "SourceGroup": "sapisu", "SourceName": "sapisu_ZRE_DS_EDW_ARCOBJT", "SourceLocation": "sapisu/ZRE_DS_EDW_ARCOBJT", "AdditionalProperty": "", "Processor": "databricks-token|0711-011053-turfs581|Standard_DS3_v2|8.3.x-scala2.12|2:8|interactive", "IsAuditTable": false, "SoftDeleteSource": "", "ProjectName": "SAP DATA", "ProjectId": 2, "TargetType": "BLOB Storage (json)", "TargetName": "sapisu_ZRE_DS_EDW_ARCOBJT", "TargetLocation": "sapisu/ZRE_DS_EDW_ARCOBJT", "TargetServer": "daf-sa-lake-sastoken", "DataLoadMode": "FULL-EXTRACT", "DeltaExtract": false, "CDCSource": false, "TruncateTarget": false, "UpsertTarget": true, "AppendTarget": null, "TrackChanges": false, "LoadToSqlEDW": true, "TaskName": "sapisu_ZRE_DS_EDW_ARCOBJT", "ControlStageId": 2, "TaskId": 46, "StageSequence": 200, "StageName": "Raw to Cleansed", "SourceId": 46, "TargetId": 46, "ObjectGrain": "Day", "CommandTypeId": 8, "Watermarks": "", "WatermarksDT": null, "WatermarkColumn": "", "BusinessKeyColumn": "", "UpdateMetaData": null, "SourceTimeStampFormat": "", "Command": "", "LastLoadedFile": null}

#Use this string in the Source Object widget
#SAPISU_ZRE_DS_EDW_ARCOBJT
...
df_cleansed = spark.sql("SELECT \
	...
	select TXT40
Join using AOTYPE / AOTYPE_AO
where SPRAS='E' as architecturalObjectType, \
	...
	select TXT40
Join using AOTYPE / AOTYPE_PA 
Where SPRAS='E' as parentArchitecturalObjectType, \
	AONR_PA as parentArchitecturalObjectNumber, \
	PARENT_PROPERTY as parentPropertyNumber, \
	_RecordStart, \
	_RecordEnd, \
	_RecordDeleted, \
	_RecordCurrent \
