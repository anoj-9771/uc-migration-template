...
#{"SourceType": "BLOB Storage (json)", "SourceServer": "daf-sa-lake-sastoken", "SourceGroup": "sapisu", "SourceName": "sapisu_ZPDMMTRGRIDCHAR", "SourceLocation": "sapisu/ZPDMMTRGRIDCHAR", "AdditionalProperty": "", "Processor": "databricks-token|0711-011053-turfs581|Standard_DS3_v2|8.3.x-scala2.12|2:8|interactive", "IsAuditTable": false, "SoftDeleteSource": "", "ProjectName": "SAP REF", "ProjectId": 2, "TargetType": "BLOB Storage (json)", "TargetName": "sapisu_ZPDMMTRGRIDCHAR", "TargetLocation": "sapisu/ZPDMMTRGRIDCHAR", "TargetServer": "daf-sa-lake-sastoken", "DataLoadMode": "FULL-EXTRACT", "DeltaExtract": false, "CDCSource": false, "TruncateTarget": false, "UpsertTarget": true, "AppendTarget": null, "TrackChanges": false, "LoadToSqlEDW": true, "TaskName": "sapisu_ZPDMMTRGRIDCHAR", "ControlStageId": 2, "TaskId": 46, "StageSequence": 200, "StageName": "Raw to Cleansed", "SourceId": 46, "TargetId": 46, "ObjectGrain": "Day", "CommandTypeId": 8, "Watermarks": "", "WatermarksDT": null, "WatermarkColumn": "", "BusinessKeyColumn": "", "UpdateMetaData": null, "SourceTimeStampFormat": "", "Command": "", "LastLoadedFile": null}

#Use this string in the Source Object widget
#SAPISU_ZPDMMTRGRIDCHAR
...
df_cleansed = spark.sql("SELECT \
	...
	cast(CHARACTERISTICINTERNALID as long) as characteristicInternalId, \
	cast(CHARACTERISTICVALUEINTERNALID as int) as characteristicvalueInternalId, \
	CLASSTYPE as classType, \
	cast(CHARCARCHIVINGOBJECTINTERNALID as int) as archivingObjectsInternalId, \
	CHARACTERISTICVALUE as characteristicValueCode, \
	ATWTB as characteristicValueDescription, \
	to_date(CHARCVALIDITYSTARTDATE, 'yyyyMMdd') as validFromDate, \
	to_date(CHARCVALIDITYENDDATE, 'yyyyMMdd') as validToDate, \
...
newSchema = StructType([
	...
	StructField('characteristicInternalId',LongType(),True,
	StructField('characteristicvalueInternalId',IntegerType(),True,
	StructField('classType',StringType(),True,
	StructField('archivingObjectsInternalId',IntegerType(),True,
