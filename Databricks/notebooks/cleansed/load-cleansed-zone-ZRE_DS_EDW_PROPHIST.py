...
#{"SourceType": "BLOB Storage (json)", "SourceServer": "daf-sa-lake-sastoken", "SourceGroup": "sapisu", "SourceName": "sapisu_ZRE_DS_EDW_PROPHIST", "SourceLocation": "sapisu/ZRE_DS_EDW_PROPHIST", "AdditionalProperty": "", "Processor": "databricks-token|0711-011053-turfs581|Standard_DS3_v2|8.3.x-scala2.12|2:8|interactive", "IsAuditTable": false, "SoftDeleteSource": "", "ProjectName": "SAP DATA", "ProjectId": 2, "TargetType": "BLOB Storage (json)", "TargetName": "sapisu_ZRE_DS_EDW_PROPHIST", "TargetLocation": "sapisu/ZRE_DS_EDW_PROPHIST", "TargetServer": "daf-sa-lake-sastoken", "DataLoadMode": "FULL-EXTRACT", "DeltaExtract": false, "CDCSource": false, "TruncateTarget": false, "UpsertTarget": true, "AppendTarget": null, "TrackChanges": false, "LoadToSqlEDW": true, "TaskName": "sapisu_ZRE_DS_EDW_PROPHIST", "ControlStageId": 2, "TaskId": 46, "StageSequence": 200, "StageName": "Raw to Cleansed", "SourceId": 46, "TargetId": 46, "ObjectGrain": "Day", "CommandTypeId": 8, "Watermarks": "", "WatermarksDT": null, "WatermarkColumn": "", "BusinessKeyColumn": "", "UpdateMetaData": null, "SourceTimeStampFormat": "", "Command": "", "LastLoadedFile": null}

#Use this string in the Source Object widget
#SAPISU_ZRE_DS_EDW_PROPHIST
...
df_cleansed = spark.sql("SELECT \
	...
	select DESCRIPTION
Join using SUPERIOR_PROP_TYPE / SUP_PROP_TYPE
where SPRAS=E as superiorPropertyType, \
	INF_PROP_TYPE as inferiorPropertyTypeCode, \
	select DESCRIPTION
Join using INFERIOR_PROP_TYPE / INF_PROP_TYPE
where SPRAS=E as inferiorPropertyType, \
	to_date(DATE_FROM, 'yyyyMMdd') as validFromDate, \
	to_date(DATE_TO, 'yyyyMMdd') as validToDate, \
	to_date(CREATED_ON, 'yyyyMMdd') as createdDate, \
	CREATED_BY as createdBy, \
	to_date(CHANGED_ON, 'yyyyMMdd') as changedDate, \
	CHANGED_BY as changedBy, \
	cast(to_unix_timestamp(DELTADATE, "yyyy-MM-dd hh:mm:ss a") as timestamp) as deltaDateTime, \
	_RecordStart, \
	_RecordEnd, \
	_RecordDeleted, \
	_RecordCurrent \
