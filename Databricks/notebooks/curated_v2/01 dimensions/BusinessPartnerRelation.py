...
def getBusinessPartnerGroupRelationship():
    ...
    isu0bpRelationsAttrDf = (
        ...
        .join(
            dim0bpartnerDf, 
            (isu0bpRelationsAttrDf.businessPartnerNumber == dim0bpartnerDf.businessPartnerNumber), 
            how="left"
        )
        .select(
            isu0bpRelationsAttrDf['*'], 
            dim0bpartnerDf['businessPartnerSK']
        )
    )
    ...
    isu0bpRelationsAttrDf = (
        ...
        .join(
            dim0bpGroupDf, 
            (isu0bpRelationsAttrDf.businessPartnerGroupNumber == dim0bpGroupDf.businessPartnerGroupNumber), 
            how="left"
        )
        .select(
            isu0bpRelationsAttrDf['*'], 
            dim0bpGroupDf['businessPartnerGroupSK']
        )
    )
