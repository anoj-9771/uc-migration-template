...
SELECT
    ...
    , CASE WHEN characteristicName in ('MTR_GRID_LOCATION_CODE') THEN characteristicInternalId ELSE NULL END AS meterGridLocationInternalId
    ...
    , CASE WHEN characteristicName in ('MR_LOCATION') THEN characteristicInternalId ELSE NULL END AS meterReadLocationInternalId
    ...
    , CASE WHEN characteristicName in ('COMMON_AREA_METER') THEN characteristicInternalId ELSE NULL END AS commonAreaMeterInternalId
    ...
    , CASE WHEN characteristicName in ('MLOC_LEVEL') THEN characteristicInternalId ELSE NULL END AS meterLocationLevelInternalId
    ...
    , CASE WHEN characteristicName in ('MLOC_DESC') THEN characteristicInternalId ELSE NULL END AS meterLocationInternalId
    ...
    , CASE WHEN characteristicName in ('MTR_PROPERTY_POSITION_ID') THEN characteristicInternalId ELSE NULL END AS meterPropertyPositionInternalId
    ...
    , CASE WHEN characteristicName in ('MTR_READ_GRID_LOCATION_CODE') THEN characteristicInternalId ELSE NULL END AS meterReadGridLocationInternalId
    ...
    , CASE WHEN characteristicName in ('RFDEVICEMODEL') THEN characteristicInternalId ELSE NULL END AS RFDeviceModelInternalId
    ...
    , CASE WHEN characteristicName in ('RFDEVICEMAKER') THEN characteristicInternalId ELSE NULL END AS RFDeviceMakerInternalId
    ...
    , CASE WHEN characteristicName in ('RF_ID') THEN characteristicInternalId ELSE NULL END AS RFIDInternalId
    ...
    , CASE WHEN characteristicName in ('WARNINGNOTES') THEN characteristicInternalId ELSE NULL END AS warningNotesInternalId
    ...
    , CASE WHEN characteristicName in ('MTR_ACCESS_NOTE') THEN characteristicInternalId ELSE NULL END AS meterAccessNoteInternalId
    ...
    , CASE WHEN characteristicName in ('MTR_READING_NOTE') THEN characteristicInternalId ELSE NULL END AS meterReadingInternalId
    ...
    , CASE WHEN characteristicName in ('METER_SERVES') THEN characteristicInternalId ELSE NULL END AS meterServesInternalId
    ...
    , CASE WHEN characteristicName in ('SO_COMMENTS') THEN characteristicInternalId ELSE NULL END AS SOCommentsInternalId
    ...
    , CASE WHEN characteristicName in ('COMMENTS') THEN characteristicInternalId ELSE NULL END AS commentsCodeInternalId
    ...
    , CASE WHEN characteristicName in ('METER_COMPLETION_NOTES') THEN characteristicInternalId ELSE NULL END AS meterCompleteNotesInternalId
    ...
    , CASE WHEN characteristicName in ('SIM_ITEM_NO') THEN characteristicInternalId ELSE NULL END AS simItemNumberInternalId
    ...
    , CASE WHEN characteristicName in ('PRJ_NUM') THEN characteristicInternalId ELSE NULL END AS ProjectNumberInternalId
    ...
    , CASE WHEN characteristicName in ('IOTFIRMWARE') THEN characteristicInternalId ELSE NULL END AS IOTFirmwareInternalId
    ...
    , CASE WHEN characteristicName in ('ADDITIONAL_INFO') THEN characteristicInternalId ELSE NULL END AS additionalInformationInternalId
    ...
    , CASE WHEN characteristicName in ('CANT_DO_CODE') THEN characteristicInternalId ELSE NULL END AS cantDoCodeInternalId
    ...
    , CASE WHEN characteristicName in ('BARCODE') THEN characteristicInternalId ELSE NULL END AS barcodeInternalId
    ...
    , CASE WHEN characteristicName in ('CENTRALISED_HOTWATER') THEN characteristicInternalId ELSE NULL END AS centralisedHotwaterInternalId
    ...
    , CASE WHEN characteristicName in ('MLIM_SYSTEM') THEN characteristicInternalId ELSE NULL END AS mlimSystemInternalId
    ...
    , CASE WHEN characteristicName in ('SITE_ID') THEN characteristicInternalId ELSE NULL END AS siteIdInternalId
    ...
    , CASE WHEN characteristicName in ('TAP_TESTED') THEN characteristicInternalId ELSE NULL END AS tapTestedInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_TYPE') THEN characteristicInternalId ELSE NULL END AS IOTTypeInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_NETWORK') THEN characteristicInternalId ELSE NULL END AS IOTNetworkInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_NETWORK_PROVIDER') THEN characteristicInternalId ELSE NULL END AS IOTNetworkProviderInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_PRESSURE_SENSOR') THEN characteristicInternalId ELSE NULL END AS IOTPressureSensorInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_PROGRAM_CATEGORY') THEN characteristicInternalId ELSE NULL END AS IOTProgramCategoryInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_PROGRAM_CATEGORY_2') THEN characteristicInternalId ELSE NULL END AS IOTProgramCategory2InternalId
    ...
    , CASE WHEN characteristicName in ('IOT_PROGRAM_CATEGORY_3') THEN characteristicInternalId ELSE NULL END AS IOTProgramCategory3InternalId
    ...
    , CASE WHEN characteristicName in ('IOT_METER') THEN characteristicInternalId ELSE NULL END AS IOTMeterInternalId
    ...
    , CASE WHEN characteristicName in ('METER_GPS_LAT_LONG_SOURCE') THEN characteristicInternalId ELSE NULL END AS meterGPSSourceInternalId
    ...
    , CASE WHEN characteristicName in ('METER_COUPLINGS') THEN characteristicInternalId ELSE NULL END AS meterCouplingInternalId
    ...
    , CASE WHEN characteristicName in ('IOT_RADIO_MODEL') THEN characteristicInternalId ELSE NULL END AS IOTRadioModelInternalId
    ...
    , CASE WHEN characteristicName in ('PULSE_SENSOR') THEN characteristicInternalId ELSE NULL END AS pulseSensorInternalId
    ...
    , CASE WHEN characteristicName in ('PULSE_SPLITTER') THEN characteristicInternalId ELSE NULL END AS pulseSplitterInternalId
    ...
    , CASE WHEN characteristicName in ('MLOC_GPS_LAT') THEN characteristicInternalId ELSE NULL END AS meterLocationGPSLatitudeInternalId
    , CASE WHEN characteristicName in ('MLOC_GPS_LAT') THEN decimalMinimumValue ELSE NULL END AS meterLocationGPSLatitude
    , CASE WHEN characteristicName in ('MLOC_GPS_LON') THEN characteristicInternalId ELSE NULL END AS meterLocationGPSLongitudeInternalId
    , CASE WHEN characteristicName in ('MLOC_GPS_LON') THEN decimalMinimumValue ELSE NULL END AS meterLocationGPSLongitude
    , CASE WHEN characteristicName in ('MR_GPS_LAT') THEN characteristicInternalId ELSE NULL END AS meterReadGPSLatitudeInternalId
    , CASE WHEN characteristicName in ('MR_GPS_LAT') THEN decimalMinimumValue ELSE NULL END AS meterReadGPSLatitude
    , CASE WHEN characteristicName in ('MR_GPS_LON') THEN characteristicInternalId ELSE NULL END AS meterReadGPSLongitudeInternalId
    , CASE WHEN characteristicName in ('MR_GPS_LON') THEN decimalMinimumValue ELSE NULL END AS meterReadGPSLongitude
    , CASE WHEN characteristicName in ('METER_OFFSET') THEN characteristicInternalId ELSE NULL END AS meterOffsetInternalId
    , CASE WHEN characteristicName in ('METER_OFFSET') THEN decimalMinimumValue ELSE NULL END AS meterOffset
    , CASE WHEN characteristicName in ('IOT_MULTIPLIER') THEN characteristicInternalId ELSE NULL END AS IOTMultiplierInternalId
    , CASE WHEN characteristicName in ('IOT_MULTIPLIER') THEN decimalMinimumValue ELSE NULL END AS IOTMultiplier
    , CASE WHEN characteristicName in ('IOT_HIGH_DAILY_CONS') THEN characteristicInternalId ELSE NULL END AS IOTHighDailyConsumptionInternalId
    , CASE WHEN characteristicName in ('IOT_HIGH_DAILY_CONS') THEN decimalMinimumValue ELSE NULL END AS IOTHighDailyConsumption
    , CASE WHEN characteristicName in ('IOT_LEAK_ALARM_THRESHOLD') THEN characteristicInternalId ELSE NULL END AS IOTLeakAlarmThresholdInternalId
    , CASE WHEN characteristicName in ('IOT_LEAK_ALARM_THRESHOLD') THEN decimalMinimumValue ELSE NULL END AS IOTLeakAlarmThreshold
    , CASE WHEN characteristicName in ('NUMBER_OF_BEDROOMS') THEN characteristicInternalId ELSE NULL END AS numberOfBedroomsInternalId
    , CASE WHEN characteristicName in ('NUMBER_OF_BEDROOMS') THEN decimalMinimumValue ELSE NULL END AS numberOfBedrooms
    , CASE WHEN characteristicName in ('CERTIFICATION_DATE') THEN characteristicInternalId ELSE NULL END AS certificateDateInternalId
    , CASE WHEN characteristicName in ('CERTIFICATION_DATE') THEN characteristicValueMaximumDate ELSE NULL END AS certificateDate
    , CASE WHEN characteristicName in ('IOT_RADIO_FIT_DATE') THEN characteristicInternalId ELSE NULL END AS IOTRadioFitDateInternalId
    , CASE WHEN characteristicName in ('IOT_RADIO_FIT_DATE') THEN characteristicValueMaximumDate ELSE NULL END AS IOTRadioFitDate
    , CASE WHEN characteristicName in ('METER_GPS_DATE_CAPTURED') THEN characteristicInternalId ELSE NULL END AS meterGPSCapturedDateInternalId
    ...
    , CASE WHEN characteristicName in ('TOTAL_REVENUE_COST') THEN characteristicInternalId ELSE NULL END AS totalRevenueCostInternalId
