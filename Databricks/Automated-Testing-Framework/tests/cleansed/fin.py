...
df = spark.table("controldb.dbo_extractLoadManifest").where(f"systemCode like '{systemCode}%' and enabled = 1")
...
DOC_PATH = 'dbfs:/mnt/data/mapping_documents_UC3/SAPEPPMRaw2Cleansed_v1'
SHEET_NAME = 'SAPFIN'
