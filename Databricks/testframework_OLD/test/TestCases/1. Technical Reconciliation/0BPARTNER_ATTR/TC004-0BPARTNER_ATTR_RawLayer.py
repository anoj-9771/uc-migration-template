...
container_name = "raw"
file_location = "wasbs://raw@sadaftest01.blob.core.windows.net/isu/0bpartner_attr/json/year=2021/month=10/day=05/0BPARTNER_ATTR_2021-10-05_163250_890.json.gz"
file_type = "json"
...
# MAGIC ,ZZPAS_INDICATOR                  
# MAGIC ,ZZUSER                                                 
# MAGIC from raw.isu_0bpartner_attr where _FileDateTimeStamp = '20210904145700'
...
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from raw.isu_0bpartner_attr where _FileDateTimeStamp = '20210904145700'
# MAGIC union all
