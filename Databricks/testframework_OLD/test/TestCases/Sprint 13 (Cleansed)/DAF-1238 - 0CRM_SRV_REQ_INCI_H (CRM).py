...
# MAGIC CRM_ISU_CONTRACT as contractId,
...
# MAGIC completedBeforeIndicator,problemGUID,notificationNumber,contractId,podStatus,statusProfile,maximoWorkOrderNumber,source,projectId,
