...
# MAGIC %sql
# MAGIC drop table if exists test.isu_0UC_BBPROC_TEXT
...
# MAGIC %sql
# MAGIC select distinct EXTRACT_DATETIME from test.isu_0UC_BBPROC_TEXT order by EXTRACT_DATETIME desc
...
# MAGIC %sql
# MAGIC select
# MAGIC billingProcedureCode,
# MAGIC billingProcedure
# MAGIC from (
# MAGIC select
...
# MAGIC from test.isu_0UC_BBPROC_TEXT) where rn=1

# COMMAND ----------

# DBTITLE 1,[Verification] Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.isu_0UC_BBPROC_TEXT
# MAGIC union all
...
# MAGIC %sql
# MAGIC SELECT billingProcedureCode,billingProcedure,
# MAGIC COUNT (*) as count
# MAGIC FROM cleansed.isu_0UC_BBPROC_TEXT
# MAGIC GROUP BY billingProcedureCode,billingProcedure
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY billingProcedureCode order by billingProcedureCode) as rn
# MAGIC FROM  cleansed.isu_0UC_BBPROC_TEXT
...
# MAGIC billingProcedure
# MAGIC from
# MAGIC cleansed.isu_0UC_BBPROC_TEXT
