...
# MAGIC %sql
# MAGIC drop table if exists test.isu_0gho_netobjs_text
...
# MAGIC %sql
# MAGIC select distinct EXTRACT_DATETIME from test.isu_0gho_netobjs_text order by EXTRACT_DATETIME desc
...
# MAGIC functionalLocationdDescription,
# MAGIC primaryLanguageIndicator,
# MAGIC functionalLocationdDescriptionCapital
# MAGIC from (
# MAGIC select
# MAGIC TPLNR as functionalLocationNumber
# MAGIC ,PLTXT as functionalLocationdDescription
# MAGIC ,KZMLA as primaryLanguageIndicator
# MAGIC ,PLTXU as functionalLocationdDescriptionCapital
# MAGIC ,row_number() over (partition by TPLNR order by extract_datetime) rn
# MAGIC from test.isu_0gho_netobjs_text) where rn=1

# COMMAND ----------

# DBTITLE 1,[Verification] Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.isu_0gho_netobjs_text
# MAGIC union all
...
# MAGIC %sql
# MAGIC SELECT functionalLocationNumber,functionalLocationdDescription,primaryLanguageIndicator,functionalLocationdDescriptionCapital, 
# MAGIC COUNT (*) as count
# MAGIC FROM cleansed.isu_0gho_netobjs_text
# MAGIC GROUP BY functionalLocationNumber,functionalLocationdDescription,primaryLanguageIndicator,functionalLocationdDescriptionCapital
...
# MAGIC functionalLocationdDescriptionCapital
# MAGIC from
# MAGIC cleansed.isu_0gho_netobjs_text
