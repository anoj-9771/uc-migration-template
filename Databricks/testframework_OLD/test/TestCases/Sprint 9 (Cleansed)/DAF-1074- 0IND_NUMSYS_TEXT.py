...
# MAGIC %sql
# MAGIC drop table if exists test.isu_0ind_numsys_text
...
# MAGIC %sql
# MAGIC select distinct EXTRACT_DATETIME from test.isu_0ind_numsys_text order by EXTRACT_DATETIME desc
...
# MAGIC ,row_number() over (partition by ISTYPE order by extract_datetime) rn
# MAGIC from test.isu_0ind_numsys_text) where rn=1

# COMMAND ----------

# DBTITLE 1,[Verification] Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.isu_0ind_numsys_text
# MAGIC union all
...
# MAGIC %sql
# MAGIC SELECT industrySystem,industry, 
# MAGIC COUNT (*) as count
# MAGIC FROM cleansed.isu_0ind_numsys_text
# MAGIC GROUP BY industrySystem,industry
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY industrySystem order by industrySystem) as rn
# MAGIC FROM  cleansed.isu_0ind_numsys_text
...
# MAGIC industry
# MAGIC from
# MAGIC cleansed.isu_0ind_numsys_text
