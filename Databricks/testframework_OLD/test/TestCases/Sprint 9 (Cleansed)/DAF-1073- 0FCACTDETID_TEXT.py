...
# MAGIC %sql
# MAGIC drop table if exists test.isu_0fcactdetid_text
...
# MAGIC %sql
# MAGIC select distinct EXTRACT_DATETIME from test.isu_0fcactdetid_text order by EXTRACT_DATETIME desc
...
# MAGIC ,row_number() over (partition by KOFIZ order by extract_datetime) rn
# MAGIC from test.isu_0fcactdetid_text) where rn=1

# COMMAND ----------

# DBTITLE 1,[Verification] Count Check
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.isu_0fcactdetid_text
# MAGIC union all
...
# MAGIC %sql
# MAGIC SELECT accountDeterminationCode, accountDetermination, COUNT (*) as count
# MAGIC FROM cleansed.isu_0fcactdetid_text
# MAGIC GROUP BY accountDeterminationCode, accountDetermination
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY accountDeterminationCode order by accountDeterminationCode) as rn
# MAGIC FROM  cleansed.isu_0fcactdetid_text
...
# MAGIC ,accountDetermination
# MAGIC from
# MAGIC cleansed.isu_0fcactdetid_text
