...
# MAGIC %sql
# MAGIC select count (*) as RecordCount, 'Target' as TableName from cleansed.t_sapisu_vibdnode
# MAGIC union all
...
# DBTITLE 1,Additional check s to target
# MAGIC %sql
# MAGIC SELECT
# MAGIC INTRENO AS architecturalObjectInternalId,
# MAGIC TREE AS alternativeDisplayStructureId,
...
# DBTITLE 1,Additional check  target to source
# MAGIC %sql
# MAGIC select
# MAGIC architecturalObjectInternalId,
# MAGIC alternativeDisplayStructureId,
