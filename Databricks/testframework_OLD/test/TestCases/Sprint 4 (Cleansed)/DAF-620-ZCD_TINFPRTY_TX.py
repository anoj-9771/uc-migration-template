...
file_location = "wasbs://archive@saswcnonprod01landingtst.blob.core.windows.net/archive/sapisu/zcd_tinfprty_tx/json/year=2021/month=08/day=05/ZCD_TINFPRTY_TX_20210804121857.json"
file_type = "json"
...
# MAGIC %sql
# MAGIC select * from cleansed.sapisu_zcd_tinfprty_tx
