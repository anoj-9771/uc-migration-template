...
# DBTITLE 1,Source after applying mapping rules
# MAGIC %sql
...
# MAGIC AENAM	as	changedBy OVER(PARTITION BY INDEXNR ORDER BY INDEXNR DESC) as rn
# MAGIC FROM raw.sapisu_eastih a) where a.rn = 1
