...
# MAGIC ,questionnaireShort
# MAGIC ,questionnaireMedium
# MAGIC ,questionnaireLong
# MAGIC from
# MAGIC (select
...
# MAGIC ,row_number() over (partition by APPLICATION,QSTNNR order by EXTRACT_DATETIME desc) as rn
...
# MAGIC SELECT
# MAGIC *,
# MAGIC row_number() OVER(PARTITION BY bwApplication,questionnaireId  order by bwApplication,questionnaireId ) as rn
# MAGIC FROM  cleansed.${vars.table}
